...
const EditorView: React.FC<any> = (props) => {
  const { user } = useAuth();
        ...
        {slides.length > 0 && activeSlide ? (
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center text-brand-text-tertiary">
              ...
              <p className="text-sm">Go to <a href="/app" className="text-brand-primary-500 hover:underline">/app</a> to create your first deck</p>
            </div>
          </div>
        )}
      </main>
