        ...
        <div className="flex items-center gap-3">
          ...
          {onNavigateToPricing && (
            <button
              ...
              className="px-4 py-2 rounded-xl glass border border-brand-primary-300/50 hover:border-brand-primary-500 transition-all text-xs font-semibold text-brand-primary-600 hover:text-brand-primary-700 hover:bg-brand-primary-50/50"
