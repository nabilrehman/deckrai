...
import { Menu, Plus, MessageSquare, ChevronDown, LogOut, Zap, BookOpen, HelpCircle, BarChart3, Folder, Upload, Library } from 'lucide-react';
                ...
                {onClearStyleLibrary && (
                  <div className="mb-4">
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all text-left group hover:bg-red-50"
                    >
                      <svg
                        width="16"
                        height="16"
                        ...
                        className="text-slate-600 group-hover:text-red-600 flex-shrink-0"
                      >
                      ...
                      <span className="text-sm text-slate-700 group-hover:text-red-600 font-normal">
                        Clear All Styles
                      </span>
                    </button>
                  </div>
                ...
                {onOpenDeckLibrary && (
                  <div className="mb-4">
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all text-left group hover:bg-slate-100/60"
                    >
                      <Folder size={16} className="text-slate-600 group-hover:text-indigo-600 flex-shrink-0" strokeWidth={2} />
                      <span className="text-sm text-slate-700 group-hover:text-slate-900 font-normal">
                        My Decks
                      </span>
                    </button>
                  ...
                  <AnimatePresence>
                    {isUserMenuOpen && (
                      ...
                      >
                        ...
                        <button
                          onClick={() => {
                            navigate('/manage-libraries');
                            setIsUserMenuOpen(false);
                            setIsExpanded(false);
                          }}
                          className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-slate-100/60 transition-all text-left"
                        >
                          <Library size={16} className="text-slate-600" strokeWidth={2} />
                          <span className="text-sm text-slate-700 font-normal">Manage Libraries</span>
                        </button>
